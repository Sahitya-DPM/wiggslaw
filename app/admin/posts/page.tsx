          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-700">
                <strong>Blog post published successfully!</strong> Your new blog post has been saved and is now live on your website.
              </p>
            </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <span>•</span>
                      <span>{new Date(post.publishedAt || post.publishDate || post.createdAt).toLocaleDateString()}</span>
                      <span>•</span>
