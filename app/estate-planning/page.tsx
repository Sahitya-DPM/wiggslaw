...
export default function EstatePlanningPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <Image
          src="/images/AdobeStock_418022877-scaled.webp"
        ...
        <div 
          ...
          style={{ zIndex: 5 }}
        ></div>
        <div className="relative z-10 max-w-4xl text-left" style={{ marginLeft: '60px' }}>
          <h1
          ...
          >
            ...
            With Comprehensive Estate Planning
          </h1>
          <p
      ...
      {/* Estate Planning Introduction Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                ...
                >
                  Build Your Legacy With an Estate Plan Today
                </button>
              </div>
            </div>
            <div>
              <Image
                src="/images/What is Estate Planning.webp"
                alt="What is Estate Planning"
                width={600}
                height={400}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Image
                src="/images/Estate Planning Goals.webp"
                alt="Estate Planning Goals"
                width={600}
                height={400}
                className="w-full h-auto object-cover rounded-lg shadow-lg"
              />
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                >
                  Be Prepared. Schedule Your Consultation Today
                </button>
              </div>
            </div>
          </div>
      ...
      {/* Planning For Long-Term Illness Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
            ...
            <div>
              <Image
                src="/images/Planning For Long-Term.webp"
                alt="Planning For Long-Term Illness or Incapacity"
                width={600}
                height={400}
                className="w-full h-auto object-cover rounded-lg shadow-lg"
              />
      ...
      {/* What Goes In My Estate Plan Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
            ...
            <div>
              <Image
                src="/images/What Goes In My Estate Plan.webp"
                alt="What Goes In My Estate Plan"
                width={600}
                height={400}
                className="w-full h-auto object-cover rounded-lg shadow-lg"
              />
